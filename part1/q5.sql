...
((SELECT dog_id FROM Dogs WHERE name = 'Reggie' AND owner_id = (select user_id FROM Users WHERE username = 'jasper')), '2025-08-10 10:30:00', 55, 'Elizabeth', 'accepted'),
((SELECT dog_id FROM Dogs WHERE name = 'Reggie' AND owner_id = (select user_id FROM Users WHERE username = 'lebronjames')), '2025-08-10 10:30:00', 55, 'Elizabeth', 'accepted'),